    ...
    try {
        switch (name) {
            case "create_ballot": {
                ...
                const durationHours = args?.duration_hours || 168;
            ...
            case "cast_vote": {
                const ballotId = args?.ballot_id;
                const optionId = args?.option_id;
                const voterAccount = args?.voter_account || "user";
            ...
            case "verify_vote": {
                const ballotId = args?.ballot_id;
                const voterAccount = args?.voter_account;
                return { content: [{ type: "text", text: JSON.stringify({
                                ballot_id: ballotId,
                                voter: voterAccount,
                                verified: true,
